...
// } from '@/entities/stores/api/store.server';
...
//   getSalesBreakDown: {
//     server: async () =>
//       (await import('@/entities/sales/api/sales.server'))
//         .getSalesBreakDownInServer,
//     client: { path: '/api/sales', method: 'GET' as const },
//   },
//   getStoreList: {
//     server: async () =>
//       (await import('@/entities/stores/api/store.server')).getStoreListInServer,
//     client: { path: '/api/store', method: 'GET' as const },
//   },
//   getStoreDetail: {
//     server: async () =>
//       (await import('@/entities/stores/api/store.server'))
//         .getStoreDetailInServer,
//     client: { path: '/api/store/:storeId', method: 'GET' as const },
//   },
//   uploadSalesFile: {
//     server: async () => (await import('@/entities/sales/api/')).uploadSalesFile,
...
//   getProductByBarcode: {
//     server: async () =>
//       (await import('@/entities/product/api/product.server'))
//         .getProductByBarcodeInServer,
